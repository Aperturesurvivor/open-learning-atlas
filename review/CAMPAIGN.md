...
the [territory inventory](inventory/mathematics-0.3.0-alpha.json) provides
...
2. Pin `mathematics-v0.3.0-alpha` or a later stated commit.
...
6. Propose corrections when needed; do not approve a dimension merely because no error was immediately obvious.

The eight review dimensions are scope/boundary, material omissions, aggregation/split quality, multi-region membership, mathematical correctness, capability observability, representation coverage, and dependency-state honesty.

## Useful first reviews

The rational/proportional, proof, graph/network, and statistical-modeling corridors have the richest relationship structure and make good first reviews. Broad specialist territories are equally valuable where a reviewer has appropriate expertise.

AI may assist with comparison, search, and drafting, but it cannot be the accountable reviewer. Territory approval also does not automatically promote every descendant record to `accepted`; record-level status follows the governance process.
