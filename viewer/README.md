...
`dev` and `build` copy `../map/releases/mathematics-v0.1.0-alpha.json` into the local public directory. `deno task check-data` verifies that the copy matches the canonical release byte for byte.
